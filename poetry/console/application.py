...
from cleo.events.console_events import ConsoleEvents
from cleo.events.dispatcher import EventDispatcher
...
class Application(BaseApplication):
    def __init__(self):
        ...
        dispatcher.add_listener(ConsoleEvents.COMMAND, self.register_command_loggers)
        dispatcher.add_listener(ConsoleEvents.COMMAND, self.set_env)
        dispatcher.add_listener(ConsoleEvents.COMMAND, self.set_installer)
    ...
    def set_env(self, event: ConsoleCommandEvent, event_name: ConsoleEvents, _: Any):
    ...
    def set_installer(
        self, event: ConsoleCommandEvent, event_name: ConsoleEvents, _: Any
    ) -> None:
